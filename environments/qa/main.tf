terraform {
  ...
  backend "gcs" {
    bucket = "emea-datafoundat-gbl-emea-qa-template-gcs-tfstate" #TODO: Change to your bucket name
...
locals {
  project_id       = "emea-datafoundat-gbl-emea-qa" #TODO: Change to your project name
  env              = "qa"
  location         = "EU"
  region           = "europe-west1"
