terraform {
  ...
  backend "gcs" {
    bucket = "emea-datafoundat-gbl-emea-np-template-gcs-tfstate" #TODO: Change to your bucket name
...
locals {
  project_id       = "emea-datafoundat-gbl-emea-np" #TODO: Change to your project name
  env              = "np"
  location         = "EU"
  region           = "europe-west1"
